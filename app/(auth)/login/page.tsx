...
export default function LoginPage() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-6 py-12">
      ...
      <p className="mt-3 text-sm text-zinc-400">TODO: wire Supabase auth form + OAuth providers.</p>
      ...
      <p className="mt-6 text-sm text-zinc-400">
        Don&apos;t have an account? <Link href="/signup" className="font-medium text-zinc-200 underline">Sign up</Link>
      </p>
    </main>
  );
}
