...
const discoverInsights: DiscoverInsight[] = [
  ...
  {
    title: "How Concentrated Your Revenue Is",
    description: "Measure whether your revenue base is diversified or concentrated — across platforms and across tiers.",
    signal: "One platform carries 62% of monthly revenue",
  ...
  {
    title: "Where Your Revenue Is Heading",
    description: "See a 3-month projection of your revenue with base, downside, and upside paths built from your own trend.",
    signal: "3-month outlook: modest upside on current trend",
    indicator: "Projected Outlook",
    bars: [20, 24, 29, 36, 56, 76],
    icon: "supporters",
    bucket: "monetization",
  },
  {
    title: "Which Tiers Hold Their Members",
    description: "See which tiers keep members and which are shedding them, with per-tier decline ratios and revenue mix.",
    signal: "Entry tier declining at 2× the rate of premium tiers",
    indicator: "Tier Health",
