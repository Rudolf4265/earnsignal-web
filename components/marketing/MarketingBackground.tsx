export function MarketingBackground() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-b from-[#0B1220] via-[#070B16] to-[#050812]" />
      <div className="absolute inset-0 bg-[radial-gradient(60%_40%_at_30%_10%,rgba(59,130,246,0.22),transparent_60%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(45%_40%_at_75%_35%,rgba(34,211,238,0.18),transparent_62%)]" />
      <div
      ...
      <svg
        aria-hidden
        viewBox="0 0 420 420"
        className="absolute right-[-120px] bottom-[-120px] h-[720px] w-[720px] opacity-[0.05] blur-[0.5px]"
      >
        <defs>
