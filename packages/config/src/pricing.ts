...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    price: "$59",
    cadence: "monthly",
    description: "Everything in Report, plus ongoing access to track how your business changes — full history, what-changed comparisons against your previous report, and an always-current dashboard.",
    features: [
      "All Report features included",
      "Full-history analysis across eligible uploads",
      "Report history with what-changed comparison to your previous report",
      "Always-current dashboard across your uploads",
