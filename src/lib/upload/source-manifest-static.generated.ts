...
// Generated from creator_optimizer commit: 7fd823f
export const STATIC_SOURCE_MANIFEST_RESPONSE: SourceManifestResponse = {
  ...
  "platforms": [
    ...
    },
    {
      ...
      "upload_help_text": "Upload either the supported Instagram normalized CSV template or your native Instagram data export ZIP. To export: go to Instagram Settings → Your activity → Download your information → select JSON format. MVP extraction uses: connections/followers_and_following/ and logged_information/past_instagram_insights/. Other folders in the ZIP are ignored safely.",
      "public_support_status": "supported_now",
